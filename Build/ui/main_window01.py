...
from core.models01 import HoleFeature
from ui.tabs.selection_tab import SelectionTab
from ui.tabs.customization_tab01 import CustomizationTab
...
class UIManager:
    ...
    def show_view(self, view_name):
        ...
        if self.holes_detected:
            ...
            # Rebuild inspection_selected_holes จากสถานะ flag ในแต่ละ HoleFeature
            self.inspection_selected_holes = [
    ...
    def update_treeview(self, holes):
        ...
        for i, hole in enumerate(holes):
            ...
            chk_zigzag.pack(anchor="w", padx=15, pady=(0, 10))
